...
function applyGridLayout(containerSelector, columns = 5, gap = '10px') {
...
// Example: Applying the grid to a products section
document.addEventListener('DOMContentLoaded', function() {
  // Apply a 5-column grid to the container with the class 'products-list'
  applyGridLayout('.products-list', 5, '10px');
});